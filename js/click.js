(function () {
  ...
  var tracksDescription = 'Soundr is a React app with redux for state managament. The files are stored on a Firebase database which enables the user to upload music and the data to be persistant. The idea behind this app was to create a music streaming service with user uploads';
  ...
  var tracksObj = { title: 'Soundr', desc: tracksDescription, link: 'https://music-store-project-61ddd.firebaseapp.com/', image: './files/imgs/pink.jpg', github: 'https://github.com/LloydPolley/Music-store' };
  ...
  var darkModeToggle = document.querySelectorAll('.dark-mode-toggle')[0];
  ...
  darkModeToggle.addEventListener('click', function(){
    document.querySelectorAll('.dm-toggle')[0].classList.toggle('dark-mode');
    console.log('run')
  })
